...
void Hud::TextureLoad()
{
	...
	controller.Texture("Resources/hud/controller.png", "./Shader/Texture2D.VS.hlsl", "./Shader/Texture2D.PS.hlsl");
}
...
void Hud::Draw(const Matrix4x4& viewProjection)
{
	...
	controller.Draw(po, Vector2(sc,sc), 0.0f, viewProjection, 0xffffffdd);
}
